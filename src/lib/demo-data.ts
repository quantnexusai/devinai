...
export const demoPortfolioProjects: PortfolioProject[] = [
  {
    ...
    outcomes: [
      ...
      { metric: 'Database Tables', before: 0, after: 15, unit: 'tables', description: 'Full RLS implementation' },
      { metric: 'User Roles', before: 0, after: 3, unit: 'roles', description: 'Buyer, Seller, Admin dashboards' },
  ...
  },
  {
    ...
    outcomes: [
      ...
      { metric: 'AI Contexts', before: 0, after: 6, unit: 'contexts', description: 'Full AI integration' },
      { metric: 'Demo Stores', before: 0, after: 3, unit: 'stores', description: 'With 24 products, 10 departments' },
      { metric: 'Delivery Windows', before: 0, after: 6, unit: 'slots', description: '2-hour delivery windows' },
    ],
  ...
  },
  {
    ...
    outcomes: [
      ...
      { metric: 'Public Pages', before: 0, after: 12, unit: 'pages', description: 'Portfolio, team, investors, blog' },
      { metric: 'Dashboard Tabs', before: 0, after: 5, unit: 'tabs', description: 'Full portfolio management' },
      { metric: 'AI Contexts', before: 0, after: 3, unit: 'contexts', description: 'Portfolio, content, market' },
    ],
  ...
  },
  {
    ...
    outcomes: [
      ...
      { metric: 'Database Tables', before: 0, after: 10, unit: 'tables', description: 'Full RLS implementation' },
      { metric: 'Dashboard Features', before: 0, after: 8, unit: 'features', description: 'Analytics, CRUD, AI reports' },
      { metric: 'CSS Animations', before: 0, after: 4, unit: 'animations', description: 'Pure CSS, no dependencies' },
    ],
  ...
  },
  {
    ...
    outcomes: [
      ...
      { metric: 'Database Tables', before: 0, after: 10, unit: 'tables', description: 'Public profiles, RLS everywhere else' },
      { metric: 'Dashboard Tabs', before: 0, after: 4, unit: 'tabs', description: 'Overview, content, supporters, settings' },
      { metric: 'Payment Flows', before: 0, after: 3, unit: 'flows', description: 'Tips, subscriptions, payouts' },
    ],
